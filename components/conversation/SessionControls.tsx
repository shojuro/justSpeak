...
export default function SessionControls({
  ...
  return (
    <div className="p-4 bg-jet/50 border-t border-warm-coral-light safe-bottom">
      {/* Mode Toggle */}
      <div className="flex justify-center mb-4">
        <div className="bg-jet/30 rounded-full p-1 flex" role="tablist" aria-label="Conversation mode selector">
          <button
      ...
      <div className="mb-4 px-4 text-center">
        <div className="text-lg text-warm-coral font-medium">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex gap-2 order-2 sm:order-1">
          <button
            ...
            className="px-6 py-3 bg-jet/50 text-warm-coral rounded-full hover:bg-jet/70 transition-colors"
          >
            End Session
          </button>
          ...
          {onProviderSettings && (
            <button
              ...
              className="p-3 bg-jet/50 text-warm-coral rounded-full hover:bg-jet/70 transition-colors"
        ...
        <button
          ...
          disabled={isSpeaking}
          className={`p-5 sm:p-4 rounded-full transition-all ${
            isListening
              ? 'bg-warm-coral text-white animate-pulse'
        ...
        {mode === 'learning' && (
          <div className="text-xs text-warm-coral/80 bg-warm-coral/10 px-3 py-1 rounded-full">
            📝 Grammar corrections enabled
          </div>
        )}
      </div>
